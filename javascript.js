...
class Deck {
  constructor() {
    ...
    console.log(
      "A deck of cards was created!  It needs to be shuffled and split!"
    );
  }
  ...
  draw(p1, p2) {
    ...
    while (!winner) {
      ...
      if (card1[0].score > card2[0].score) {
        ...
        pot.push(war2);
        console.log(
          "You each put the top card of your library into the pot, then there is another round."
        );
      }
  ...
  split(p1, p2) {
    ...
    console.log(
      playerOne.name,
      " has ",
      playerOne.library.length,
      " cards.  ",
      playerTwo.name,
      " has ",
      playerTwo.library.length,
      " cards."
    );
  }
...
var playerOne = new Player(
  prompt("Player One: please input your name."),
  [],
  0,
  []
);
var playerTwo = new Player(
  prompt("Player Two: please input your name"),
  [],
  0,
  []
);
...
console.log(
  "Welcome to WAR!  Refer to the README file if you need help!  Have fun!"
);
